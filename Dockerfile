...
RUN mkdir /var/log/SBB && \
    touch /var/log/SBB/hsp-fo-discovery.log && \
    chmod 664 /var/log/SBB/hsp-fo-discovery.log && \
    chown ${DISCOVERY_USER}:${DISCOVERY_USER} /var/log/SBB/hsp-fo-discovery.log
